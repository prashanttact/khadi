  ...
  <section class="content" style="position:relative">
    <div class="row mrg-b20">
      <div class="col m8 s12 no-mrg">
        <h1 class="head-title"><span class="gry-light">Edit Board of Directors</span></h1>
      </div>
    ...
    <div class="right-bg" id="basic-information">
      <div class="inner_form ui-slider-tabs">
        ...
        <form name="updateBoards" action="<?php echo url('update-boards/'.$data['results']->id); ?>" method="POST" id="updateBoards" enctype="multipart/form-data">
            ...
            <div class="col-md-12 formFldCont">
              ...
              <div class="row">
                <div class="col-md-12 mrg-b25">
                  ...
                  <div class="col-md-8">
                   <input id="name" name="name" type="text" class="validate" value="<?php echo $data['results']->board_name; ?>" placeholder="Director Name">
               ...
               <div class="col-md-12 mrg-b25">
                <div class="row">
                  ...
                  <div class="col-md-8">
                   <input id="title" name="title" type="text" class="validate" value="<?php echo $data['results']->board_title; ?>" placeholder="Director Title">
              ...
              <div class="col-md-12 mrg-b25">
                ...
                <div class="col-md-8">
                  ...
                  <div class="file-field">
                   <img src="<?php echo url('frontend/kscl/assets/img/boards/'.$data['results']->board_images ); ?>" class="showImage" width="100px;" height="100px;" />
                 </div>
               </div>
             </div>
           </div>
