    ...
    <section class="content" style="position:relative">
        <div class="row mrg-b20">
            <div class="col m8 s12 no-mrg">
                <h1 class="head-title"><span class="gry-light">View Alert</span></h1>
            </div>
            <div class="col m4 s12 right-align right mrg-t20"></div>
        </div>
                ...
                <div class="card card-bg">
                    ...
                    <table id="myDataTable" class="table table-bordered table-striped mrg-b0 table-responsive">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td><center><?php echo $row->alert_desc; ?></center></td>
                                <td><center><?php echo date("d F,Y", strtotime($row->alert_date)); ?></center></td>
                                <td><center><img src="<?php echo url('frontend/kscl/assets/img/alerts/'.$row->alert_image); ?>" width="50"></center></td>
                                <td><center>
                                    <a href = "<?php echo url('edit-alert/' . $row->id); ?>">
                                        <img src="<?php echo url("images/edit.png"); ?>" width="18" height="18" title="Edit">
                                    </a>
                                    &nbsp;
                                    <a href = "<?php echo url('delete-alert/' . $row->id); ?>" onclick="return confirm('Are you sure! do you want to delete?')">
                            ...
                            { 
                                echo '<tr class="errorClass"><th colspan="5"><center>No records..</center></th></tr>'; 
                            }
                            ?>
                        </tbody>
                    </table>
