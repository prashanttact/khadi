<div class="content-content_container">
  ...
  <h1 class="head-title"><span class="gry-light">Edit Alerts </span></h1>
  </div>
  <div class="col m4 s12 right-align right required_msg">    <div class="back-align">
               <a href="{{ url('view-alert') }}"><i class="far fa-arrow-alt-circle-left"></i> Back</a>
...
<form name="updateAlert" action="<?php echo url('update-alert/'.$data['results']->id); ?>" method="POST" id="updateAlert" enctype="multipart/form-data">
...
<div class="col-md-8">
<textarea style="margin: 0px; height: 96px;" class="ckeditor" id="description" name="description" placeholder="Description"><?php echo $data['results']->alert_desc; ?></textarea>
...
<div class="col-md-3">
<input id="date" name="date" type="text" class="validate datePicker" value="<?php echo date('j F, Y', strtotime($data['results']->alert_date)); ?>" placeholder="DD/MM/YYY">
 <div class="errorClass"><?php echo $errors->first('alert_date'); ?></div>
</div>
</div>
</div>
...
<div class="col-md-8">
<div class="file-field">
     <img src="<?php echo url('frontend/kscl/assets/img/alerts/'.$data['results']->alert_image ); ?>" class="showImage" width="100px;" height="100px;" />
</div>
</div>
</div>
</div>
