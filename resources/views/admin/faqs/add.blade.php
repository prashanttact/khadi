...
<form name="insertFaqs" action="<?php echo url('insert-faq'); ?>" method="POST" id="insertfaqs" enctype="multipart/form-data">
...
<select required name="faq_category">
  @if(isset($data))
    @foreach($data['category_list'] as $category_list)
...
<div class="errorClass"><?php echo $errors->first('category_id'); ?></div>
</div>
</div>
...
<div class="col-md-3 fldLabel">
<span class="required_fild"></span>
FAQ Questions: <b style="color:red">*</b>
</div>
<div class="col-md-8">
<!--
 ...
 --> 
 <textarea required style="margin: 0px; height: 75px;" class="1ckeditor" id="faq_question" name="faq_question" placeholder="Write question here">{{ old('faq_question') }}</textarea>
...
<div class="col-md-8">
<textarea required style="margin: 0px; height: 150px;" class="1ckeditor" id="faq_answer" name="faq_answer" placeholder="Write answer here">{{ old('faq_answer') }}</textarea>
