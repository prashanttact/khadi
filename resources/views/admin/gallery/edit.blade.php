<div class="content-content_container">
  ...
  <h1 class="head-title"><span class="gry-light">Edit Gallery </span></h1>
  </div>
...
<form name="updateGallery" action="<?php echo url('update-gallery/'.$data['results']->id); ?>" method="POST" id="updateGallery" enctype="multipart/form-data">
...
<div class="col-md-8">
 <input id="category" name="category" type="text" class="validate" value="<?php echo $data['results']->category; ?>" placeholder="Category">
...
<div class="col-md-8">
 <input id="title" name="title" type="text" class="validate" value="<?php echo $data['results']->image_title; ?>" placeholder="Image Title">
...
<div class="file-field">
     <img src="<?php echo url('frontend/kscl/assets/img/gallery/'.$data['results']->gallery_image ); ?>" class="showImage" width="100px;" height="100px;" />
</div>
</div>
</div>
</div>
